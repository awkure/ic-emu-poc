...
static CANISTER_NAME: &str = "canister-a";
...
impl LocalState {
    pub fn new() -> Self {
        Self(Rc::new(RefCell::new(CanisterState { a: 1 })))
    }
...
pub fn call_b() {
    println!("calling canister-b");
    STATE.with(|s| s.state.0.borrow().call("canister-b", "show_meta"));
}
